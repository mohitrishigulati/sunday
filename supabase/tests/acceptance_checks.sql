...
BEGIN
  ...
  BEGIN
    ...
    VALUES
      ...
      (v_maker, '00000000-0000-0000-0000-000000000000', 'authenticated', 'authenticated', 'maker@acceptance.local', crypt('test-pass', gen_salt('bf')), now(), '{"provider":"email","providers":["email"]}'::jsonb, '{"full_name":"Maker DE"}'::jsonb, now(), now())
