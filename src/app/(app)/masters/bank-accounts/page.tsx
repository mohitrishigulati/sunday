...
export default async function BankAccountsPage() {
  ...
  const [{ data: companies }, { data: banks }, { data: rows }, { data: accountGroups }] = await Promise.all([
  ...
  return <div className="space-y-8">
    ...
    <BankAccountForm companies={companies ?? []} banks={banks ?? []} accountGroups={accountGroups ?? []} />
