...
export default async function PaymentTransactionPage() {
  ...
  return (
    <div className="space-y-8">
      <TransactionTypeNav active="payment" />
      <PageHeader title="Payment" description="Cash gaya ya bank se pay hua. Party / ledger choose karke save karo." />
      ...
      <section className="space-y-3">
        <h2 className="text-lg font-semibold">Bank payment</h2>
        <BankEntryForm
