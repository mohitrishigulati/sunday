...
export default async function JournalTransactionPage() {
  ...
  return (
    <div className="space-y-8">
      <TransactionTypeNav active="journal" />
      <PageHeader title="Journal Entry" description="Balanced multi-line journal — na cash, na bank, sirf Debit / Credit." />
